// Log points defined by the application
    ...
    EVENT_HELLO_REQUEST_SENT,
    EVENT_HELLO_REQUEST_SEND_FAILURE,
    EVENT_HELLO_RESPONSE_RECEIVED,
    EVENT_NO_HELLO_RESPONSE,
    EVENT_HELLO_RESPONSE_TIMEOUT,
    EVENT_UPLINK_DELAY_MICROSECONDS,
    EVENT_ROUNDTRIP_DELAY_MICROSECONDS,
    EVENT_AUDIO_SERVER_CONNECTED,
