...
// For testing only: define this to write data to file.
//#define URTP_TEST_OUTPUT_FILENAME "/home/pi/urtp.data"

#ifdef URTP_TEST_OUTPUT_FILENAME
#include <stdio.h>
#include <string.h>
#include <errno.h>
#endif
...
#ifdef URTP_TEST_OUTPUT_FILENAME
static FILE *urtpOutputFile = NULL;
#endif
...
#ifdef URTP_TEST_OUTPUT_FILENAME
        if (urtpOutputFile != NULL) {
            fwrite(&monoSample, sizeof(monoSample), 1, urtpOutputFile);
        }
#endif
...
#ifdef URTP_TEST_OUTPUT_FILENAME
        urtpOutputFile = fopen(URTP_TEST_OUTPUT_FILENAME, "wb+");
        if (urtpOutputFile == NULL) {
            printf("Cannot open URTP test output file %s (%s).\n", URTP_TEST_OUTPUT_FILENAME, strerror(errno));
        }
#endif
